...
export const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-900 pt-20">
      {/* Background Elements */}
