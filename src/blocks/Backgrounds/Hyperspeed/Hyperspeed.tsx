...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  // Create a stable string representation of options to prevent unnecessary re-renders
  const optionsKey = JSON.stringify(effectOptions);
  ...
  }, [optionsKey]); // Depend on stable string representation
