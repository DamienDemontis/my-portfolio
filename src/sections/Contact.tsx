    ...
    <section id="contact" className="section-padding relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto container-padding relative z-10">
        ...
        >
          ...
          >
            <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center shadow-lg mx-auto">
          ...
          >
            <div className="w-24 h-1 bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 rounded-full"></div>
            <div className="absolute w-32 h-3 bg-gradient-to-r from-green-400/20 via-emerald-400/20 to-teal-400/20 blur-sm rounded-full"></div>
          </motion.div>
